...
ninja.data = [{
    ...
    handler: () => {
      ...
      section: "Posts",
      handler: () => {
        window.location.href = "/al-folio/blog/2022/displaying-external-posts-on-your-al-folio-blog/";
      },
      ...
      section: "Posts",
      handler: () => {
        window.location.href = "/al-folio/blog/2022/redirect/";
      },
    ...
    },{id: "project-project-3-with-very-long-name",
